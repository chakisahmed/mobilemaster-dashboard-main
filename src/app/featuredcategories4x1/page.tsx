...
const FeaturedCategories4xNPage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchGroupContainers = async () => {
            try {
                const response = await axios.get('/api/featuredcategories4xn/featuredcategories4x1');
    ...
    const handleCreateLayout = async () => {
        try {
            ...
            const groupResponse = await axios.post('/api/featuredcategories4xn', {
                name: layoutName,
                layout_type: 'featuredcategories4x1'
            });
            ...
            const createdcategories = await axios.post('/api/featuredcategories', {
                ...
                names: names,
                images: base64Images,
                layout_type: `featuredcategories4x1-${groupContainer[0].id}`
            });
            ...
            {showModal && (
                <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
                    <div className="bg-white p-4 rounded">
                        <h2 className="text-xl font-bold mb-4">Create 4x1 Categories Layout</h2>
                        <input 
                            type="text" 
