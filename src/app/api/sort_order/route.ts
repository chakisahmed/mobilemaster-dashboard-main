...
export async function GET(req: Request) {
    try {
        ...
        const response = await axios.get('https://ext.web.wamia.tn/rest/V1/mobilemaster/sortorder', {
            headers: {
...
export async function POST(request: Request) {
    try {
        ...
        const response = await axios.post('https://ext.web.wamia.tn/rest/V1/mobilemaster/sortorder', {
            'layout_id': layout_id,
            'label': label,
            'position': position,
            'type': type,
