...
//https://customer.wamia.tn/rest/V1/mobilemaster/sortorder/swap {"id1":1,"id2":2,"pos1":1, "pos2":2}
export async function PUT(req: Request) {
    try {
        ...
        const response = await axios.put('https://customer.wamia.tn/rest/V1/mobilemaster/sortorder/swap', body, {
            headers: {
